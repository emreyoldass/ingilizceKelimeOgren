...
{
    public partial class Zamanakarsi : Form
    {
        public Zamanakarsi()
        {
            InitializeComponent();
        }
        //acces bir tablo oluştur ve bir giriş formu oluştur kullanıcı ismini alın sisteme giriş yaptı sonra o kullanıcın kaçtane doğru bildiği veritabnına kaydet
        ...
        void getir()
        {
            ...
            while (dr.Read())
            {
                txt_ingilizce.Text = dr[1].ToString();
        ...
        private void txt_türkce_TextChanged(object sender, EventArgs e)
        {
            if (txt_türkce.Text == lbl_cevap.Text)
            {
