...
{
    public partial class KelimeBulmaİngilizce : Form
    {
        public KelimeBulmaİngilizce()
        {
            InitializeComponent();
        }
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            getir();
            ingilizcekelime = lbl_ingilizce.Text;
            foreach (var item in ingilizcekelime.ToCharArray(0, ingilizcekelime.Length))
            {
                dizi.Add(item);
            }
        ...
        private void Btn_harfgetir_Click(object sender, EventArgs e)
        {
            ...
            if (lbl_ingilizce.Text.Length != olusanbuton)
            {
                if (kac >= 6)
                {
                    x = 176;
        ...
        void getir()
        {
            ...
            while (dr.Read())
            {
                lbl_ingilizce.Text = dr[1].ToString();
                lbl_cevap.Text = dr[2].ToString();
            }
            baglanti.Close();
        ...
        {
            if (txt_cevap.Text == lbl_ingilizce.Text)
            {
                ögrencidetay.ögrenilenKelime(lbl_ingilizce.Text, lbl_cevap.Text);
                dogrukelime++;
        ...
        {
            MessageBox.Show(lbl_ingilizce.Text, "İpucu", MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
